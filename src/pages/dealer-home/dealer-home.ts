...
import { TransferPointsWalletPage } from '../DMS/Transfer-Points/transfer-points-wallet/transfer-points-wallet';
import { TransferRequestListingPage } from '../DMS/Transfer-Points/transfer-request-listing/transfer-request-listing';
import { SendPointRequestListingPage } from '../DMS/Transfer-Points/send-point-request-listing/send-point-request-listing';
import { StockPage } from '../DMS/stock-manage/stock/stock';
import { PointTransferLedgerPage } from '../DMS/Transfer-Points/point-transfer-ledger/point-transfer-ledger';
import { TransferRequestAddPage } from '../DMS/Transfer-Points/transfer-request-add/transfer-request-add';
import { ReturnPointListingPage } from '../DMS/Transfer-Points/return-point-listing/return-point-listing';
import { AndroidPermissions } from '@ionic-native/android-permissions';
import { ScanningPage } from '../scanning/scanning';
import { OpenNativeSettings } from '@ionic-native/open-native-settings';
import { DrGiftGalleryListingPage } from '../DMS/DrGiftGallery/dr-gift-gallery-listing/dr-gift-gallery-listing';
...
export class DealerHomePage {
    ...
    // ----------------------DMS SUNIl START---------------------------------//
    goToPointTransfer() {
        this.navCtrl.push(TransferPointsWalletPage);
    }

    goToTransferRequest() {
        this.navCtrl.push(TransferRequestListingPage);
    }

    goToSendTransferRequest() {
        this.navCtrl.push(SendPointRequestListingPage);
    }
    ...
    goOnPTTransferLedger() {
        this.navCtrl.push(PointTransferLedgerPage);
    }

    goToSendPoints() {
        this.navCtrl.push(TransferRequestAddPage, { 'type': 'Transfer' });
    }
    ...
    //....................Dolly DMS Gift Gallery Start..........................//
    goToGiftList() {
        this.navCtrl.push(DrGiftGalleryListingPage)
    }
    //....................Dolly DMS Gift Gallery End............................//
    ...
    scanProduct() {
        ...
        this.barcodeScanner.scan(options).then(resp => {
            ...
            if (resp.text != '') {
                ...
                this.serve.addData({ 'coupon_code': this.qr_code, }, 'AppCouponScan/fetchProduct').then((r: any) => {
                    if (r['statusCode'] == 200) {
                        let result;
                        result = r['result']
                        setTimeout(() => {
