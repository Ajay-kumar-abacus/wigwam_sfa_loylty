...
export class TravelPopOverPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public viewCtrl: ViewController, private menu: MenuController,public serve:MyserviceProvider) {
    ...
    this.NavType_page = this.navParams.get('type');
    console.log(this.NavType_page)
  ...
  closeLead(type) {
    // return type
    this.viewCtrl.dismiss({ 'TabStatus': type,'list_type':'created_by' });
  }
  ...
  go_to(type) {
    ...
    if (type == 'Primary') {
      ...
      this.navCtrl.push(SecondaryOrderPage, { 'comes_from_which_page': 'leads-details', 'dr_code': this.dr_code, 'dr_id': this.dr_id, 'type': 'order', 'dr_type': this.DrType })
      //  this.navCtrl.pop({animate:false})
        ...
        this.navCtrl.push(SecondaryOrderPage, { 'comes_from_which_page': 'leads-details', 'dr_code': this.dr_code, 'dr_id': this.dr_id, 'type': 'stock', 'dr_type': this.DrType })
        //  this.navCtrl.pop({animate:false})
