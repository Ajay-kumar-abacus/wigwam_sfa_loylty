...
export class LmsLeadAddPage {
  ...
  constructor(public diagnostic: Diagnostic,public Device:Device,public navCtrl: NavController, public modalCtrl: ModalController, public navParams: NavParams,private camera: Camera,public db:MyserviceProvider,private alertCtrl: AlertController,public loadingCtrl: LoadingController) {
    this.getNetworkType()
this.source()
